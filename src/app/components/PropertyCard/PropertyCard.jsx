...
const PropertyCard = ({ data }) => {
    ...
    return (
        //--------------------------------LOCAL WORK--------------------------------
        <Link href={`/SinglePropertyListing/${title}?arrival_date=${'2/1/2025'}&departure_date=${'2/1/2025'}`} className="bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer flex flex-col">
            <div className="relative flex-1 aspect-square">
                <Image src={'/hotel1.webp'} alt={title} fill className="object-cover aspect-square" />
            ...
            <div className="p-4 flex flex-col justify-between flex-1">
                ...
                <div className="mt-3 flex items-center justify-between">
                    <span className="text-lg font-bold">PKR {price}</span>
